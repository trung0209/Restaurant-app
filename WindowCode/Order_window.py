...
class Ui_menu(object):
    ...
    def setupUi(self, menu):
        ...
        #         # self.tableOrder.setGeometry(QtCore.QRect(590, 30, 301, 461))
        ...
        self.tableOrder_2 = QtWidgets.QTableWidget(self.centralwidget)
        self.tableOrder_2.setGeometry(QtCore.QRect(890, 30, 301, 461))
        self.tableOrder_2.setRowCount(3)
        self.tableOrder_2.setColumnCount(2)
        self.tableOrder_2.setObjectName("tableOrder_2")
        self.tableOrder_2.horizontalHeader().setDefaultSectionSize(136)
    ...
    def openMessage(self):
        ...
        temp = self.order1.get_dict()
        index = 0
        self.tableOrder_2.setRowCount(len(temp.keys())+1)
        for key,value in temp.items():
            self.tableOrder_2.setItem(index,0,QTableWidgetItem(key))
            self.tableOrder_2.setItem(index,1,QTableWidgetItem(str(value)))
            index += 1
        self.order_row = 0
